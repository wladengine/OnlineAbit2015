<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Abiturient/PersonalOffice.Master" Inherits="System.Web.Mvc.ViewPage<OnlineAbit2013.Models.PriorityChangerProfileModel>" %>
...
<script type="text/javascript" src="../../Scripts/jquery-ui-1.8.11.js"></script>
    ...
    -> 
    <a href="../Abiturient/PriorityChangerApplication?AppId=<%= Model.ApplicationId.ToString("N") %>&V=<%= Model.ApplicationVersionId.ToString("N") %>"><%= Model.ObrazProgramName %></a>
    -> 
    ...
    <form action="/Abiturient/PriorityChangeProfile" method="post">
