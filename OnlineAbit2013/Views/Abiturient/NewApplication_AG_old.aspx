...
<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Abiturient/PersonalOffice.Master" Inherits="System.Web.Mvc.ViewPage<AG_ApplicationModel>" %>
...
<script type="text/javascript">
    ...
    function GetProfs(i) {
        ...
        $(currProfile).html('');
        $(currExams).html('');
        $.post('/Abiturient/GetProfs_AG', { classid: $('#EntryClassId').val(), profileId: $(currProfiles).val(), CommitId : $('#CommitId').val() }, function (json_data, i) {
            if (json_data.IsOk) {
    ...
    function GetSpecializations(i) {
        ...
        $(currProfile).html('');
        $(currExams).html('');
        $.post('/Abiturient/GetSpecializations_AG', { classid: $('#EntryClassId').val(), programid: $(currProfiles).val(), profileid: $(currProfessions).val(), CommitId : $('#CommitId').val() }, function (json_data, i) {
            if (json_data.IsOk) {
                $(currObrazProgramErrors).text('').hide();
    ...
    function CheckSpecialization(i) {
        ...
        $.post('/Abiturient/CheckSpecializations_AG', { classid: $('#EntryClassId').val(), programid: $(currProfiles).val(), specid: $(currProfessions).val(), CommitId : $('#CommitId').val() }, function (json_data) {
            if (json_data.IsOk) {
                $(currObrazProgramErrors).text('').hide();
                if (json_data.HasProfileExams) {
                    $(currManualExam).show();
    ...
    function mkButton(i) {
        ...
        $.post('/Abiturient/CheckApplication_AG', { Entryclass: $('#EntryClassId').val(), profession: $(currProfile).val(), profileid: $(currProfessions).val(), manualExam : $(currManualExam).val(), NeedHostel: $(currNeedHostel).is(':checked'), CommitId : $('#CommitId').val() }, function(json_data) {
            if (json_data.IsOk) {
                $('#FinishBtn' + i).show();
            }
            else {
    ...
    function SaveData(i) {
        ...
        $.post('/Abiturient/AddApplication_AG', { Entryclass: $('#EntryClassId').val(), profession: $(currProfile).val(), profileid: $(currProfessions).val(), manualExam : $(currExams).val(), NeedHostel: $(currNeedHostel).is(':checked'), CommitId : $('#CommitId').val() }, function(json_data) {
            if (json_data.IsOk) {
    ...
    function DeleteApp(i) {
        ...
        $.post('/Abiturient/DeleteApplication_AG', { id : appId, CommitId : $('#CommitId').val() }, function(json_data) {
            if (json_data.IsOk) {
